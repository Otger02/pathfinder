            ...
            <div className="space-y-2">
              {documents.map((doc, i) => (
                <a
                  ...
                  href={doc.url}
                  download={doc.name}
                  className="flex items-center gap-3 px-3 py-2.5 bg-primary/5 rounded-lg hover:bg-primary/10 transition-colors group"
                >
                  <svg className="w-5 h-5 text-primary shrink-0" fill="none" stroke="currentColor" strokeWidth={1.8} viewBox="0 0 24 24" aria-hidden="true">
