 ...
 * 3 pages, 96 fields. Clean Texto1..Texto72 + Casilla de verificación73..96.
 */
...
export const EX_04_TEXT_FIELDS: Record<string, PersonalDataField | null> = {
  ...
  Texto27: "entitat_nombre",
  Texto28: "entitat_nifNie",
  Texto29: "entitat_actividad",
  Texto30: "entitat_ocupacion",
  Texto31: "entitat_domicilio",
  Texto32: "entitat_numero",
  Texto33: "entitat_piso",
  Texto34: "entitat_localidad",
  Texto35: "entitat_codigoPostal",
  Texto36: "entitat_provincia",
  Texto37: "entitat_telefono",
  Texto38: "entitat_email",
  Texto39: "entitat_repNombre",
  Texto40: "entitat_repDniNie",
  Texto41: "entitat_repTitulo",
...
export const EX_04_TIPO_AUTORIZACION_CHECKBOXES: Record<string, string> = {
  "Casilla de verificación82":  "inicial_exterior_convenio",
  "Casilla de verificación83":  "inicial_exterior_contrato",
  "Casilla de verificación84":  "inicial_espanya_convenio",
  "Casilla de verificación85":  "inicial_espanya_contrato",
  "Casilla de verificación86":  "renovacion_convenio",
  "Casilla de verificación87":  "renovacion_contrato",
  "Casilla de verificación88":  "familiar_inicial",
  "Casilla de verificación89":  "familiar_renovada",
  "Casilla de verificación90":  "tipo_90",
  "Casilla de verificación91":  "tipo_91",
  "Casilla de verificación92":  "tipo_92",
  "Casilla de verificación93":  "tipo_93",
  "Casilla de verificación94":  "tipo_94",
  "Casilla de verificación95":  "tipo_95",
  "Casilla de verificación96":  "tipo_96",
};
